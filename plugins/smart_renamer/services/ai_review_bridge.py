    ...
    def analyze(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return {
            **self.status(),
            ...
            "candidate_id": str(result.get("candidate_id") or result.get("recommended_candidate_id") or ""),
            "recommended_candidate_id": str(result.get("recommended_candidate_id") or result.get("candidate_id") or ""),
            "recommended_fields": dict(result.get("recommended_fields") or {}),
            "structured_recommendation": dict(result.get("structured_recommendation") or {}),
            "execution_allowed": False,
            "requires_human_confirmation": True,
            "human_confirmation_required": True,
        }
