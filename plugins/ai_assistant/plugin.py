...
class MediaHubAIAssistantPlugin:
    ...
    def execute_source_scan(
        ...
        franchise_knowledge_graph = self.franchise_knowledge_graph.build(
            semantic_result=semantic,
            semantic_reasoning=semantic_reasoning,
            temporal_causal_intelligence=temporal_causal_intelligence,
            narrative_intelligence=narrative_intelligence,
        ...
        character_relationship_graph = self.character_relationship_graph.build(
            relationship_intelligence=relationship_intelligence,
            character_relationship_intelligence=character_relationship_intelligence,
            character_relationship_engine=character_relationships,
            franchise_knowledge_graph=franchise_knowledge_graph,
            source=dict(source),
        )

        character_relationship_graph = CharacterEntityFilter.filter_graph_payload(
        ...
        relationship_confidence = self.relationship_confidence_engine.build(
            character_relationship_graph=character_relationship_graph,
            franchise_knowledge_graph=franchise_knowledge_graph,
        ...
        character_timeline = self.character_timeline_engine.build(
            character_relationship_graph=character_relationship_graph,
            story_timeline=story_timeline,
        ...
        cross_franchise = self.cross_franchise_resolver.build(
            franchise_knowledge_graph=franchise_knowledge_graph,
            entity_resolution_graph=entity_resolution_graph,
        ...
        canonical_decisions = self.canonical_decision_engine.build(
            canonical_conflicts=canonical_conflicts,
            relationship_confidence=relationship_confidence,
        ...
        architecture_validation = {
            ...
            "summary": {
                ...
                "missing_pipeline_module_count": 0,
                "duplicate_strategy_count": 0,
                "initialization_error_count": 0,
                "error_count": 0,
                "warning_count": 1,
            },
            "errors": [],
            "warnings": [
                "architecture_validation_not_available_in_this_execution_path"
            ],
            "automatic_import": False,
            "requires_confirmation": True,
        }
        ...
        relationship_consistency = self.relationship_consistency_checker.build(
            global_knowledge=global_knowledge,
            knowledge_graph_validation=knowledge_graph_validation,
        ...
        architecture_validation = self.ai_architecture_validator.build(
            ...
            strategy_map={
                "relationship_confidence": relationship_confidence.get("strategy"),
                "character_relationship_graph": character_relationship_graph.get("strategy"),
                "character_timeline": character_timeline.get("strategy"),
                "character_evolution": character_evolution.get("strategy"),
                "character_memory": character_memory.get("strategy"),
                "canonical_conflicts": canonical_conflicts.get("strategy"),
                "cross_franchise": cross_franchise.get("strategy"),
                "canonical_decisions": canonical_decisions.get("strategy"),
                "global_knowledge": global_knowledge.get("strategy"),
            },
